...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_traps=5, num_opponents=2, custom_walls=None):
        self.width = width
        self.height = height
        ...
        while len(self.toxic_traps) < num_traps:
            ...
            if trap_pos(trap_pos != (0,0) and trap_pos not in self.walls
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            x = tx * self.cell_size
            y = (self.env.height - 1 - ty) * self.cell_size
            self.canvas.create_polygon(
                x + self.cell_size / 2, y + offset,                     
                x + self.cell_size - offset, y + self.cell_size / 2,    
                x + self.cell_size / 2, y + self.cell_size - offset,    
                x + offset, y + self.cell_size / 2,                      
                fill="purple",
                outline="darkmagenta"
            )
