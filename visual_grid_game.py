...
class GridGameGUI:
    ...
    def __init__(self, root, width=10, height=10, num_food=12, num_opponents=2, num_traps=2, walls=None):
        self.root = root
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            self.canvas.create_oval(x1, y1, x1 + self.cell_size * 0.5, y1 + self.cell_size * 0.5, fill="purple", outline="darkmagenta")
