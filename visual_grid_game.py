...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None, num_toxic_traps=3):
        self.width = width
        self.height = height
...
class GridGameGUI:
    ...
    def __init__(self, root, width=10, height=10, num_food=12, num_opponents=2, walls=None, num_toxic_traps=3):
        self.root = root
...
if __name__ == "__main__":
    ...
    app = GridGameGUI(root, width=12, height=12, num_food=15, num_opponents=0, num_toxic_traps=4)
    root.mainloop()